...
class Observation(Target):
    ...
    def __init__(
        ...
        self.angle = 0.0
        self.fieldId = 0
        self.five_sigma_depth = 0.0
        self.groupId = 0
        self.night = 0
        self.observation_id = 0
        self.observation_start_lst = 0.0
        self.observation_start_mjd = 0.0
        self.observation_start_time = 0.0
        self.seeing_fwhm_500 = 0.0
        self.seeing_fwhm_eff = 0.0
        self.seeing_fwhm_geom = 0.0
        self.visit_time = 0.0
        self.moon_alt = 0.0
        self.sun_alt = 0.0
    ...
    def make_copy(observation, check=False):
        """
        Receives an iterable object (like a dictionary) and return a copy of
        Observation. If check==True makes sure the basic parameters are part of
        observation. Raise an exception otherwise.
